...
class ProtogenHUB75SenseProject : public ProtogenProject {
private:
...
public:
    ProtogenHUB75SenseProject() : ProtogenProject(&cameras, &controller, 2, Vector2D(), Vector2D(192.0f, 94.0f), 14, 20, 9){
